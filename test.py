...
weather_data = {
    ...
    "맑음 - 무더움 🔥": {
        ...
        "이미지": "https://cdn-icons-png.flaticon.com/512/2938/2938105.png"  # 불
    },
    "흐림 - 쌀쌀 ☁️": {
        "기분": "차분, 다소 우울",
        "호르몬": ["멜라토닌 (Melatonin)", "세로토닌 감소"],
        "이미지": "https://cdn-icons-png.flaticon.com/512/4814/4814268.png"  # 바람
    },
    "흐림 - 습함 🌫️": {
        "기분": "무기력, 답답함",
        "호르몬": ["코르티솔 (Cortisol)", "세로토닌 감소"],
        "이미지": "https://cdn-icons-png.flaticon.com/512/728/728093.png"  # 물방울
    },
    "비 - 소나기 🌦️": {
        "기분": "차분, 안정",
    ...
    "비 - 폭우 🌧️": {
        ...
        "이미지": "https://cdn-icons-png.flaticon.com/512/1146/1146869.png"  # 비와 번개
    },
    "눈 - 폭설 🌨️": {
        "기분": "고립감, 스트레스 가능",
        "호르몬": ["코르티솔 (Cortisol)", "세로토닌 변동"],
        "이미지": "https://cdn-icons-png.flaticon.com/512/642/642102.png"  # 눈
    }
}
